...
class DefaultTemp implements ITemplate {
    ...
    public function layout($caminho, $parametro = null) {
        ...
        if (file_exists($caminhoCompleto)) {
            ...
            echo "<h2 style='color: #e74c3c;'> Arquivo não encontrado</h2>";
            ...
            echo "<a href='/mvcPlantas/' style='color: #27ae60;'>Voltar ao início</a>";
            echo "</div>";
        }
